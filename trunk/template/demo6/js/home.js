...
var datatype=$("#hamburgermenu").attr("data-type");
    $(".dhgl>li ").each(function(){
        try{
            ...
            if("index"==datatype){
                if(myid=="item-index"){
                    $("#item-index a:first-child").addClass("on");
                }
                ...
                if(infoid!=null){
                    ...
                    for(var i=0;i<b.length;i++){
                        if(myid=="category-"+b[i]){
                            $("#category-"+b[i]+" a:first-child").addClass("on");
                        }
                    }
                }
                ...
                if(infoid!=null){
                    if(myid=="page-"+infoid){
                        $("#page-"+infoid+" a:first-child").addClass("on");
                    }
                }
                ...
                if(infoid!=null){
                    if(myid=="tag-"+infoid){
                        $("#tag-"+infoid+" a:first-child").addClass("on");
                    }
                }
            }
        }catch(E){}
...
$(function() {
	$(".zklb").click(function(){
	  ...
	  $(this).prev().toggleClass("lbheightauto");
	});	
